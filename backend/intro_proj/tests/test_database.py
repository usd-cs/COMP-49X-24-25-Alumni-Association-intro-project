...
class DatabaseTests(TestCase):
    ...
    def test_comment_user_cascade(self):
        test_user = User.objects.create(email='user@sandiego.edu', name='John User')
        test_user_2 = User.objects.create(email='user2@sandiego.edu', name='John User2')
        test_post = Post.objects.create(author=test_user, content='cool post')
    ...
    def test_user_duplicate_email(self):
        User.objects.create(email='user@sandiego.edu', name='John User')
        with self.assertRaises(Exception):
            User.objects.create(email='user@sandiego.edu', name='Another User')
